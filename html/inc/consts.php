...
//SNR NAGTECH
// Class
define("SNR_NAGTECH_POE_CLASS",".1.3.6.1.4.1.57206.7.100.26.10.1.9");
// Status
define("SNR_NAGTECH_POE_OID",".1.3.6.1.4.1.57206.7.100.26.10.1.2");
// VOLTAGE
define("SNR_NAGTECH_POE_VOLT",".1.3.6.1.4.1.57206.7.100.26.10.1.7");
// CURRENT
define("SNR_NAGTECH_POE_CURRENT",".1.3.6.1.4.1.57206.7.100.26.10.1.6");
// POWER USAGE
define("SNR_NAGTECH_POE_USAGE",".1.3.6.1.4.1.57206.7.100.26.10.1.5");
